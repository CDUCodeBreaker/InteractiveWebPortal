<%@ Page Title="WebPortal | Admin" Language="C#" MasterPageFile="~/Forms/WebPortal.Master" AutoEventWireup="true" CodeBehind="AdminPage.aspx.cs" Inherits="InteractiveWebPortal.Forms.AdminPage" %>
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="list-group">
                            <a href="AdminPage.aspx" class="list-group-item  active main-color-bg">
                    ...
                    <div class="col-sm-9">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div class="form-group">
                                    <div style="overflow-x: auto;">
                                        <asp:GridView ID="gvApprovedMember" runat="server" GridLines="None" CssClass="table table-striped table-hover" AllowPaging="true" PageSize="10" AutoGenerateColumns="False" EmptyDataText="There are no data records to display.">
                                            <Columns>
                                                <asp:BoundField DataField="UserID" Visible="false" />
                                                <asp:BoundField DataField="Name" HeaderText="Name" />
                                                <asp:BoundField DataField="MembershipNo" HeaderText="Membership#" />
                                                ...
                                                <asp:TemplateField ItemStyle-HorizontalAlign="Right" ShowHeader="False">
                                                    <ItemTemplate>
                                                        <asp:Button ID="btnGenerate" runat="server" CssClass="btn btn-primary" OnClientClick="aspnetForm.target ='_blank';" OnClick="btnGenerate_Click" Text="E-Card" />
                                                        <asp:Button ID="btnRemoveFromApprove" CssClass="btn btn-primary" runat="server" OnClick="btnRemoveFromApprove_Click" Text="Remove" />
                                                        <asp:Button ID="btnBlock" CssClass="btn btn-primary" runat="server" OnClick="btnBlock_Click" Text="Block" />
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                            </Columns>
                                        </asp:GridView>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ScriptSection" runat="server">
    <script type="text/javascript">
        function ConvertToImage(btnGenerate) {

            html2canvas($("#ECard")[0]).then(function (canvas) {
                alert("hi");
                var base64 = canvas.toDataURL();
                $("[id*=hfImageData]").val(base64);
                __doPostBack(btnGenerate.name, "");
            });
            return false;
        }
    </script>
